...
export default function TopCenter(){
    return(
        <div className="w-full h-[1000px] xs:h-[300px] xs:flex-col bg-[#FFF9F4] flex flex-col items-center ">
            <div className="w-full bg-[#FFF9F4] h-[50%] flex flex-row justify-between items-center relative top-[-3.9%]">
