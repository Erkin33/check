export default function TextAbout() {
  return (
    <div className="w-full h-[450px] flex justify-around items-center flex-col xs:h-[200px]">
      {/* Основной текстовый блок */}
      <div className="w-[60%] xs:w-[90%] h-[60%] xs:h-auto flex justify-center items-center text-center">
        <h1 className="text-[2vw] xs:text-[4vw] font-medium leading-relaxed uppercase">
          I am passionately 
      ...
      <div className="w-[13%] xs:w-[20%] h-[30%] xs:h-[10%] rounded-t-full absolute bg-[url('/Shorts/Black.webp')] bg-cover bg-no-repeat right-[-10%] xs:right-[5%] xs:mt-[25%]"></div>
    </div>
  );
}
