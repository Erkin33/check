  ...
  return (
    <div className="w-full h-auto flex flex-col lg:flex-row bg-[#F5E7D6] p-6 rounded-lg shadow-md gap-6">
      ...
      <div className="lg:w-1/2 w-full flex flex-col justify-start gap-4">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">Frequently Asked Questions</h1>
        <p className="text-gray-600 text-base sm:text-lg lg:text-xl">
          Row itself, let it be sorrow; let him love it; let him pursue it, wishing for its acquisition.
        </p>
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">Working Hours</h2>
        <p className="text-sm sm:text-base lg:text-lg text-gray-800">Monday - Friday (08:00am to 08.00pm)</p>
        <p className="text-sm sm:text-base lg:text-lg text-gray-800">Saturday & Sunday (08:00am to 05.00pm)</p>
        <a
          href="#"
          className="w-40 h-10 bg-[#0E343D] text-white flex justify-center items-center rounded-md text-sm sm:text-base lg:text-lg"
        >
          More Questions
          <img
            src="ArrowWhite.svg"
