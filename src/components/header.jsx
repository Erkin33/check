...
export default function Header() {
    const Adv = () => {
        return(
            <p className="text-[white] md:text-[1.2vh] xs:text-[1.5vh]">
      ...
      return(
        <div className="w-full h-full  flex flex-row xs:text-[2vh] xs:flex-col justify-around items-center">
          <ul className="w-[30%] xs:w-full xs:justify-around md:w-[35%] h-full justify-between items-center flex flex-row">
            <li><a href="/" className="md:text-[1.5vh] xs:text-[2.5vh] lg:text-[2vh] ">Home</a></li>
            <li><a href="/collection" className="md:text-[1.5vh] xs:text-[2.5vh] lg:text-[2vh]">Collection</a></li>
            <li><a href="/" className="md:text-[1.5vh] xs:text-[2.5vh] lg:text-[2vh]">Shop</a></li>
            <li><a href="/blog" className="md:text-[1.5vh] xs:text-[2.5vh] lg:text-[2vh]">Blog</a></li>
            <li><a href="/contactUs" className="md:text-[1.5vh] xs:text-[2.5vh] lg:text-[2vh]">Contact Us</a></li>
          </ul>
          ...
          <div className="w-[20%] xs:w-full md:w-[35%] lg:w-[25%] h-full flex flex-row justify-between items-center">
            ...
            <a href="#" className="bg-[#0e343d] text-center lg:text-[1.7vh] align-center w-[60%] h-[80%] center flex justify-center items-center text-[#ffffff]">Get Special Offers</a>
            </div>
    ...
    const Options = () => {
      ...
      const changeDefault = () => {
        ...
        return(
          ...
          <h3 className="text-[white] xs:text-[2vh]">EN</h3>
          <button onClick={changeDefault} className="w-[20%] xs:text-[3vh] py-[0em] px-[0em] bg-[#0e343d] text-[white]">&#x1F847;</button><br />
          ...
          <div ref={disapper} style={{display:"none"}} className="bg-[red] h-[10%] w-[10%] absolute flex flex-col justify-center items-center mr-[0%] mt-[9%]">
            <a className="w-full text-center flex justify-center items-center h-1/2 bg-[white] cursor-pointer hover:bg-[#282c34] xs:text-[2vh]">RU</a>
            <a className="w-full text-center flex justify-center items-center h-1/2 bg-[white] cursor-pointer hover:bg-[#282c34] xs:text-[2vh]">EU</a>
          </div>
        </div>
        )
    }
